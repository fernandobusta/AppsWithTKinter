...
# Create a Function to Save the Edited Record
def update():
	# Create a database or connect to one
	conn = sqlite3.connect('address_book.db')
	# Create cursor
...
def edit():
	...
	editor.iconbitmap('images/calc.ico')
	...
	edit_btn = Button(editor, text="Save Redord", command=update)
...
edit_btn = Button(root, text="Edit Redord", command=edit)
